...
LRESULT CALLBACK paint_sinx(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	PAINTSTRUCT ps;
	HDC hdc;
	static int sx, sy;
...
LRESULT CALLBACK paint_xOnX(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	PAINTSTRUCT ps;
	HDC hdc;
	static int sx, sy;
...
LRESULT CALLBACK paint_sin_rotation(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	PAINTSTRUCT ps;
	HDC hdc;
	static HPEN hpen1, hpen2;
...
LRESULT CALLBACK paint_individual(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	PAINTSTRUCT ps;
	HDC hdc;
	static int sx, sy;
...
LRESULT CALLBACK paint_individual_rotation(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	PAINTSTRUCT ps;
	HDC hdc;
	static HPEN hpen1, hpen2;
...
{
	//return paint_sinx(hWnd, message, wParam, lParam);
	//return paint_xOnX(hWnd, message, wParam, lParam);
	//return paint_sin_rotation(hWnd, message, wParam, lParam);
	//return paint_individual(hWnd, message, wParam, lParam);
	return paint_individual_rotation(hWnd, message, wParam, lParam);
